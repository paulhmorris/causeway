    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "size-7 sm:w-7 sm:h-7 bg-transparent p-0 opacity-50 hover:opacity-100",
        ),
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "size-9 sm:w-9 sm:h-9 p-0 font-normal aria-selected:opacity-100"),
